...
- **Telegram оповещения** — пересылка сообщений из MAX в Telegram канал/чат (текст, фото, видео, описание аудио, ответы и пересланные сообщения)
...
- **Видео** — пересылается как видео с подписью
...
Сейчас в проекте 179 unit-тестов.
